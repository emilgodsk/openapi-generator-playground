...
namespace MyPackageClient.Api
{
    ...
    /// </summary>
    public interface IHealthCheckApiResponse : MyPackageClient.Client.IApiResponse, IOk<MyPackageClient.Model.HealthCheck200Response?>
    {
        /// <summary>
    ...
    public sealed partial class HealthApi : IHealthApi
    {
        ...
        /// </summary>
        public partial class HealthCheckApiResponse : MyPackageClient.Client.ApiResponse, IHealthCheckApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public MyPackageClient.Model.HealthCheck200Response? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<MyPackageClient.Model.HealthCheck200Response>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out MyPackageClient.Model.HealthCheck200Response? result)
            {
                result = null;

...
using MyPackageClient.Client;
using MyPackageClient.Model;
...
namespace MyPackageClient.Api
{
    ...
    /// </summary>
    public interface IGetJobApiResponse : MyPackageClient.Client.IApiResponse, IOk<MyPackageClient.Model.Job?>, INotFound<MyPackageClient.Model.Error?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IListJobsApiResponse : MyPackageClient.Client.IApiResponse, IOk<List<Job>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface ISubmitJobApiResponse : MyPackageClient.Client.IApiResponse, ICreated<MyPackageClient.Model.Job?>, IBadRequest<MyPackageClient.Model.Error?>
    {
        /// <summary>
    ...
    public sealed partial class JobsApi : IJobsApi
    {
        ...
        /// </summary>
        public partial class GetJobApiResponse : MyPackageClient.Client.ApiResponse, IGetJobApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public MyPackageClient.Model.Job? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<MyPackageClient.Model.Job>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out MyPackageClient.Model.Job? result)
            {
                result = null;
            ...
            /// </summary>
            /// <returns></returns>
            public MyPackageClient.Model.Error? NotFound()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsNotFound
                    ? System.Text.Json.JsonSerializer.Deserialize<MyPackageClient.Model.Error>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryNotFound([NotNullWhen(true)]out MyPackageClient.Model.Error? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class ListJobsApiResponse : MyPackageClient.Client.ApiResponse, IListJobsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class SubmitJobApiResponse : MyPackageClient.Client.ApiResponse, ISubmitJobApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public MyPackageClient.Model.Job? Created()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsCreated
                    ? System.Text.Json.JsonSerializer.Deserialize<MyPackageClient.Model.Job>(RawContent, _jsonSerializerOptions)
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryCreated([NotNullWhen(true)]out MyPackageClient.Model.Job? result)
            {
                result = null;
            ...
            /// </summary>
            /// <returns></returns>
            public MyPackageClient.Model.Error? BadRequest()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsBadRequest
                    ? System.Text.Json.JsonSerializer.Deserialize<MyPackageClient.Model.Error>(RawContent, _jsonSerializerOptions)
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryBadRequest([NotNullWhen(true)]out MyPackageClient.Model.Error? result)
            {
                result = null;

...
[assembly: InternalsVisibleTo("MyPackageClient.Test")]
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is bool boolean)
                return boolean
                    ? "true"
                    : "false";
            if (obj is DataExportJob.FormatEnum dataExportJobFormatEnum)
                return DataExportJob.FormatEnumToJsonValue(dataExportJobFormatEnum);
            if (obj is DataExportJobRequest.TypeEnum dataExportJobRequestTypeEnum)
                return DataExportJobRequest.TypeEnumToJsonValue(dataExportJobRequestTypeEnum);
            if (obj is DataExportJobRequest.FormatEnum dataExportJobRequestFormatEnum)
                return DataExportJobRequest.FormatEnumToJsonValue(dataExportJobRequestFormatEnum);
            if (obj is EmailJobRequest.TypeEnum emailJobRequestTypeEnum)
                return EmailJobRequest.TypeEnumToJsonValue(emailJobRequestTypeEnum);
            if (obj is Job.FormatEnum jobFormatEnum)
                return Job.FormatEnumToJsonValue(jobFormatEnum);
            if (obj is JobRequest.TypeEnum jobRequestTypeEnum)
                return JobRequest.TypeEnumToJsonValue(jobRequestTypeEnum);

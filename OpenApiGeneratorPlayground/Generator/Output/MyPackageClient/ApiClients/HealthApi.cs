...
namespace MyPackageClient.ApiClients
{
    ...
    /// </summary>
    public interface IHealthCheckApiResponse : MyPackageClient.Common.IApiResponse, IOk<MyPackageClient.Models.HealthCheck200Response?>
    {
        /// <summary>
    ...
    public sealed partial class HealthApi : IHealthApi
    {
        ...
        /// </summary>
        public partial class HealthCheckApiResponse : MyPackageClient.Common.ApiResponse, IHealthCheckApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public MyPackageClient.Models.HealthCheck200Response? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<MyPackageClient.Models.HealthCheck200Response>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out MyPackageClient.Models.HealthCheck200Response? result)
            {
                result = null;
